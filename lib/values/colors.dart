...
class AppColors {
  ...
  static const Color secondaryElement =Color(0xFFFF0000);
  ...
  static const Color kpizzaGreen = Color.fromRGBO(76, 217, 100, 1);
  static const Color kpizzaYellow = Color(0xFFFFCC00);
//  static const Color kpizzaGoldRatingStar = Color(0xFFFFCC00);
  static const Color kpizzaGreyRatingStar = Color(0xFFDFE4ED);
  static const Color kpizzaSkyBlue = Color(0xFFEEF7FF);
  static const Color kpizzaDarkBackground = Color(0xFF25262E);
  static const Color kpizzaUnselectedSliderDot = Color(0xFF6A6A6A);
